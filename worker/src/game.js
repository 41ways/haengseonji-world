/* 행선지2: World — 정답 고르기와 거리·점수 계산. 서버와 테스트가 같이 쓴다 */
...
/* 1번 문제 = 2026-09-14 (KST) */
export const EPOCH = kstDay(Date.UTC(2026, 8, 13, 15));
...
/* 199일에 한 바퀴. 한 바퀴 안에서는 같은 나라가 두 번 나오지 않는다 */
...
/* 점수 — 정답이 100점, 그 밖은 가까운 순서 한 계단마다 0.5점씩 낮아진다 (198번째가 1점). 소수 둘째 자리까지.
