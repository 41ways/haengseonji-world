...
정답 수도에 가까운 순서로 매긴 점수(100점 만점)만 보고 오늘의 나라를 맞히는 하루 한 문제 게임. 제일 적게 불러 맞힌 사람이 1등.
...
- 입력칸에 지역 이름을 끝까지 치면 그 지역 나라가 전부 가나다순으로 나온다 — 대륙, 북미(미국·캐나다·멕시코)·중미·카리브·남미·중남미, 동아시아·동남아·남아시아·중앙아시아·서아시아·중동(코카서스 빼고 이집트·이란 넣음), 북유럽(북유럽 5국+발트 3국)·서유럽(영국·아일랜드 포함)·남유럽·동유럽(중부·발칸 포함)·중부유럽·발칸, 북·서·동·중부·남부 아프리카, 멜라네시아·폴리네시아. 나라 이름과 같은 말(미크로네시아)은 나라가 먼저. 지역만 친 채 Enter 는 부르지 않는다 (`search-block.js` 의 `GROUPS`)
- 옛 한자 음차명(불란서·화란·이태리·월남 …)도 별칭으로 찾는다. 목록에는 본이름과 지역만 보인다 (`build/countries.py` 의 `KO`)
