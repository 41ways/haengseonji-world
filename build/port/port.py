...
rep('<meta name="description" content="정답에 가까운 순서로 매긴 점수만 보고 오늘의 시·군을 맞히는 하루 한 문제 게임. 제일 빨리 맞힌 사람이 1등.">',
    '<meta name="description" content="정답 수도에 가까운 순서로 매긴 점수만 보고 오늘의 나라를 맞히는 하루 한 문제 게임. 제일 빨리 맞힌 사람이 1등.">')
rep('<meta property="og:title" content="행선지 — 오늘의 시·군 맞히기">', '<meta property="og:title" content="행선지2: World — 오늘의 나라 맞히기">')
rep('<meta property="og:description" content="가까운 순서 점수만 보고 전국 165개 시·군 중 오늘의 정답을 찾아라. 제일 빨리 맞힌 사람이 1등.">',
    '<meta property="og:description" content="가까운 순서 점수만 보고 세계 199곳 중 오늘의 행선지를 찾아라. 제일 빨리 맞힌 사람이 1등.">')
...
block('      <li>매일 자정(한국 시간)에 전국 <b>시·군 165곳</b>', '    </ul>', '''      <li>매일 자정(한국 시간)에 <b>199곳</b> 중 한 나라가 오늘의 행선지가 됩니다.</li>
      ...
      <li>시계는 <b>첫 추측부터</b> 정답까지 서버가 잽니다. 순위는 빠른 순, 시간이 같으면 적게 부른 순입니다. 포기하면 순위에 오르지 않습니다.</li>
